 ...
 */
 ...
 /**
 * Checked Malloc isimli fonksiyon standart malloc fonksiyonunun 
 * sarmalayıcısıdır. Bu isleme augmentation denilmektedir.
 */ 
 ...
 /**
 * _itoa fonksiyonunun parametrik yapisini degistirmek icin my 
 * itoa olmasi iscin mitoa isimli wrapper fonksiyonu yazilmistir.
 * _itoa(int val, char *p, int base); -> itoa fonksiyonu prototipi
 * @param p yazinin adresi
 * @param val yaziya donusturulecek sayi
 */
 char* mitoa(char *p, int val)
 {
	 //default olarak sayi sistemi 10 secilmistir.
	return _itoa(val, p, 10);
 }
